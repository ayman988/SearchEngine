...
public class UnitTest {
	...
	public void testindexDirectorySimple() {
		...
		try {
			...
			List<ISearchResult> expected = Arrays.asList(new SearchResult[]{new SearchResult("7709081", 1), new SearchResult("7697770", 1), new SearchResult("7703892", 1),new SearchResult("7707155", 1),new SearchResult("7723686", 1),new SearchResult("7701540", 12)});
			List<ISearchResult> actual = searchEngine.searchByWordWithRanking("Connolly");
			for (ISearchResult searchRes : actual) {
				System.out.println(searchRes.toString());
			}
			Collections.sort(actual, new Comparator<ISearchResult>() {
	...
	public void testDeleteWebPageSimple() {
		...
		try {
			...
			List<ISearchResult> expected = Arrays.asList(new SearchResult[]{new SearchResult("7708196", 8)});
			List<ISearchResult> actual = searchEngine.searchByWordWithRanking("Luttenbachers");
			for (ISearchResult searchRes : actual) {
				System.out.println(searchRes.toString());
			}
			Collections.sort(actual, new Comparator<ISearchResult>() {
	...
	public void testsearchByMultipleWordWithRanking() {
		...
		try {
			searchEngine.indexDirectory("res");
			List<ISearchResult> expected = Arrays.asList(new SearchResult[]{new SearchResult("7720389", 1)});
			List<ISearchResult> actual = searchEngine.searchByMultipleWordWithRanking(" antisubmarine Guam Sharkhunt 	");
			for (ISearchResult searchRes : actual) {
				System.out.println(searchRes.toString());
			}
			Collections.sort(actual, new Comparator<ISearchResult>() {
